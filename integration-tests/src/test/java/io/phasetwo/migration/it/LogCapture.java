...
/**
 * In-JVM logback appender used to assert what the migrator logged on a given run. Attach before the
 * action under test, then read events. Detach in a finally to avoid leaks across tests.
 */
