...
public class WorkOSLegacyResource {
    ...
    public Response getUser(
        ...
        try { identities = w.listUserIdentities(u.id()); } catch (Exception e) { identities = List.of(); }
        ...
        if (u.profilePictureUrl() != null) attrs.set(AttributeKeys.WORKOS_PROFILE_PICTURE_URL, arr(u.profilePictureUrl()));
        if (u.lastSignInAt() != null) attrs.set(AttributeKeys.WORKOS_LAST_SIGN_IN_AT, arr(u.lastSignInAt()));
        if (u.metadata() != null) {
