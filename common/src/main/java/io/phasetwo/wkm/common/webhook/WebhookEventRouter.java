...
import io.phasetwo.wkm.common.sync.DirectoryGroupSync;
import io.phasetwo.wkm.common.sync.DirectorySync;
import io.phasetwo.wkm.common.sync.IdentityProviderSync;
import io.phasetwo.wkm.common.sync.OrganizationMembershipSync;
import io.phasetwo.wkm.common.sync.OrganizationSync;
import io.phasetwo.wkm.common.sync.RoleSync;
import io.phasetwo.wkm.common.sync.SyncContext;
import io.phasetwo.wkm.common.sync.SyncResult;
import io.phasetwo.wkm.common.sync.UserSync;
import io.phasetwo.wkm.common.util.JsonUtil;
import io.phasetwo.wkm.common.workos.model.WConnection;
import io.phasetwo.wkm.common.workos.model.WDirectory;
import io.phasetwo.wkm.common.workos.model.WDirectoryGroup;
import io.phasetwo.wkm.common.workos.model.WOrgMembership;
import io.phasetwo.wkm.common.workos.model.WOrganization;
import io.phasetwo.wkm.common.workos.model.WRole;
import io.phasetwo.wkm.common.workos.model.WUser;
import io.phasetwo.wkm.common.workos.model.WebhookEvent;
...
public class WebhookEventRouter {
    ...
    private SyncResult deleteUser(JsonNode data) {
        ...
        return io.phasetwo.wkm.common.keycloak.Lookups.userByWorkosId(ctx.realm(), id)
                .map(u -> {
    ...
    private SyncResult deleteOrg(JsonNode data) {
        ...
        return io.phasetwo.wkm.common.keycloak.Lookups.orgByWorkosId(ctx.phaseTwo(), ctx.realmName(), id)
                .map(o -> {
    ...
    private SyncResult removeMembership(JsonNode data) {
        ...
        var user = io.phasetwo.wkm.common.keycloak.Lookups.userByWorkosId(ctx.realm(), userId);
        var org = io.phasetwo.wkm.common.keycloak.Lookups.orgByWorkosId(ctx.phaseTwo(), ctx.realmName(), orgId);
