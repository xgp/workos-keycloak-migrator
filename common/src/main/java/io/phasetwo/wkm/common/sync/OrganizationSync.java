...
import io.phasetwo.wkm.common.workos.model.WOrgDomain;
...
public class OrganizationSync implements EntitySync<WOrganization> {
    ...
    public SyncResult sync(WOrganization o) {
        ...
        Map<String, List<String>> attrs = rep.getAttributes() == null
                ? new LinkedHashMap<>() : new LinkedHashMap<>(rep.getAttributes());
        ...
        SyncResult result = new SyncResult(ENTITY, o.id(), domainPartial ? SyncAction.PARTIAL : action)
                .withKeycloakId(ptId);
